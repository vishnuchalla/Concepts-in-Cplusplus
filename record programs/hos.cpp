...
{static int count;
 ...
 {cout<<FBLU("Enter the file name for storage\n");
  ...
  cin>>gua;
  cout<<FRED("Enter the occupation of the patienet\n");
  cin>>ocu;
  ...
  cin>>dis;
  cout<<FRED("Enter the name of his/her doctor and Fee charged\n");
  cin>>doc>>bill;
 ...
 void modify()
{
  ...
  switch(ch)
 {
   case 1:cout<<FYEL("Enter the new unique  ID of the Item\n");
          cin>>id;
          break;
...
{ 
  ...
  {cout<<FGRN("\n             *********************************************************************************************************************************\n");
  cout<<FYEL("                           Sno:     ID:     Name:         Quantity:   Price:      Total Amount:\n");
...
{patient *pa[1000];
 ...
 switch(c)
 {
  ...
  case 4:countmd=0;
         ...
         switch(ch)
         {
         case 1:m[im]=new class medicine();
                m[im]->data();
                im++;
                nm++;
                system(cls);
                ...
                break;
         case 2:flagm=0;
                cout<<"Enter the R.no of the Employee for modification\n";
                cin>>no;
                for(im=0;im<nm;im++)
                {if(no==(m[im]->reg()))
                 m[im]->modify();
         ...
         case 3:flam=0;
                system(cls);
                cout<<"Enter the R.no of the Employee for display\n";
                cin>>no;
                for(im=0;im<nm;im++)
                {if(no==(m[im]->reg()))
                m[im]->display();
